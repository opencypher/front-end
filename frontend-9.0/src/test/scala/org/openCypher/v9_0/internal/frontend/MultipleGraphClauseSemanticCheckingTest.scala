...
import org.openCypher.v9_0.internal.parser
import org.openCypher.v9_0.internal.parser.{ParserTest, Statement}
import org.openCypher.v9_0.internal.util.helpers.StringHelper
...
class MultipleGraphClauseSemanticCheckingTest
  ...
  case class TestState(astStatement: ast.Statement) extends BaseState {

    override def statement(): ast.Statement = astStatement

    override def queryText: String = astStatement.toString
    ...
    override def withStatement(s: ast.Statement) = copy(s)
