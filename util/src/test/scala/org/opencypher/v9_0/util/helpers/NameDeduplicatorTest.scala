...
class NameDeduplicatorTest extends CypherFunSuite {
  ...
  test("should reformat autogenerated variables names with UUIDs") {
    removeGeneratedNamesAndParams("  UNNAMED42(17debdfe-6233-42f6-be08-941b2163bddd)") should equal("anon_42")
  }
  ...
  test("should reformat autogenerated param names with UUIDs") {
    removeGeneratedNamesAndParams("  AUTOINT33(17debdfe-6233-42f6-be08-941b2163bddd)") should equal("autoint_33")
  }
  ...
  test("does not greedily consume more than the UUID in autogenerated variable name") {
    removeGeneratedNamesAndParams("  UNNAMED42(17debdfe-6233-42f6-be08-941b2163bddd)(this is not part of the uuid)") should equal("anon_42(this is not part of the uuid)")
  }

  test("does not greedily consume more than the UUID in autogenerated param name") {
    removeGeneratedNamesAndParams("  AUTOINT42(17debdfe-6233-42f6-be08-941b2163bddd)(this is not part of the uuid)") should equal("autoint_42(this is not part of the uuid)")
  }
