      ...
      statement.folder.treeExists {
        ...
        case u: UseGraph =>
          throw cypherExceptionFactory.syntaxException(
            "The USE clause is not supported in this Cypher version.",
            u.position
          )

        case c: UnresolvedCall if c.yieldAll =>
          throw cypherExceptionFactory.syntaxException(
            "Procedure call using `YIELD *` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateRangeNodeIndex if c.fromDefault =>
          throw cypherExceptionFactory.syntaxException(
            "Creating index using this syntax is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateRangeRelationshipIndex if c.fromDefault =>
          throw cypherExceptionFactory.syntaxException(
            "Relationship property indexes are not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateLookupIndex =>
          throw cypherExceptionFactory.syntaxException(
            "Lookup indexes are not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateFulltextNodeIndex =>
          throw cypherExceptionFactory.syntaxException(
            "Fulltext indexes can only be created using procedures in this Cypher version.",
            c.position
          )
        ...
        case d: DropIndexOnName =>
          throw cypherExceptionFactory.syntaxException(
            "Dropping index by name is not supported in this Cypher version.",
            d.position
          )
        ...
        case c @ CreateNodeKeyConstraint(_, _, _, Some(_), _, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating named node key constraint is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateNodeKeyConstraint(_, _, _, _, IfExistsDoNothing, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node key constraint using `IF NOT EXISTS` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateNodeKeyConstraint(_, _, _, _, _, options, _, _, _) if options != NoOptions =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node key constraint with options is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateUniquePropertyConstraint(_, _, _, Some(_), _, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating named uniqueness constraint is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateUniquePropertyConstraint(_, _, _, _, IfExistsDoNothing, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating uniqueness constraint using `IF NOT EXISTS` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateUniquePropertyConstraint(_, _, _, _, _, options, _, _, _) if options != NoOptions =>
          throw cypherExceptionFactory.syntaxException(
            "Creating uniqueness constraint with options is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateNodePropertyExistenceConstraint(_, _, _, Some(_), _, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating named node existence constraint is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateNodePropertyExistenceConstraint(_, _, _, _, IfExistsDoNothing, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node existence constraint using `IF NOT EXISTS` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateNodePropertyExistenceConstraint if c.constraintVersion == ConstraintVersion1 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node existence constraint using `IS NOT NULL` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateNodePropertyExistenceConstraint(_, _, _, _, _, options, _, _, _) if options != NoOptions =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node existence constraint with options is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateRelationshipPropertyExistenceConstraint(_, _, _, Some(_), _, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating named relationship existence constraint is not supported in this Cypher version.",
            c.position
          )
        ...
        case c @ CreateRelationshipPropertyExistenceConstraint(_, _, _, _, IfExistsDoNothing, _, _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating relationship existence constraint using `IF NOT EXISTS` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateRelationshipPropertyExistenceConstraint if c.constraintVersion == ConstraintVersion1 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating relationship existence constraint using `IS NOT NULL` is not supported in this Cypher version.",
            c.position
          )

        // CREATE CONSTRAINT [name] FOR ()-[r:R]-() REQUIRE (r.prop) IS NOT NULL OPTIONS {...}
        case c @ CreateRelationshipPropertyExistenceConstraint(_, _, _, _, _, options, _, _, _)
          if options != NoOptions =>
          throw cypherExceptionFactory.syntaxException(
            "Creating relationship existence constraint with options is not supported in this Cypher version.",
            c.position
          )
        ...
        case d: DropConstraintOnName =>
          throw cypherExceptionFactory.syntaxException(
            "Dropping constraint by name is not supported in this Cypher version.",
            d.position
          )

        case e: ExistsSubClause =>
          throw cypherExceptionFactory.syntaxException(
            "Existential subquery is not supported in this Cypher version.",
            e.position
          )

        // SHOW [ALL|FULLTEXT|LOOKUP|POINT|RANGE|TEXT] INDEX[ES] [WHERE clause|YIELD clause]
        case s: ShowIndexesClause =>
          throw cypherExceptionFactory.syntaxException(
            "SHOW INDEXES is not supported in this Cypher version.",
            s.position
          )
        ...
        case s: ShowConstraintsClause =>
          throw cypherExceptionFactory.syntaxException(
            "SHOW CONSTRAINTS is not supported in this Cypher version.",
            s.position
          )
        ...
        case c: ShowProceduresClause =>
          throw cypherExceptionFactory.syntaxException(
            "`SHOW PROCEDURES` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: ShowFunctionsClause =>
          throw cypherExceptionFactory.syntaxException(
            "`SHOW FUNCTIONS` is not supported in this Cypher version.",
            c.position
          )
    ...
    override def check(statement: Statement, cypherExceptionFactory: CypherExceptionFactory): Unit =
      statement.folder.treeExists {
        ...
        case c: UniquePropertyConstraintCommand if c.properties.size > 1 =>
          throw cypherExceptionFactory.syntaxException(
            "Multi-property uniqueness constraints are not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateRangeNodeIndex if !c.fromDefault =>
          throw cypherExceptionFactory.syntaxException(
            "Range indexes are not supported in this Cypher version.",
            c.position
          )
        case c: CreateRangeRelationshipIndex if !c.fromDefault =>
          throw cypherExceptionFactory.syntaxException(
        ...
        case s: ShowIndexesClause if s.indexType == RangeIndexes =>
          throw cypherExceptionFactory.syntaxException(
            "Filtering on range indexes in SHOW INDEXES is not supported in this Cypher version.",
            s.position
          )
        ...
        case c: CreateTextNodeIndex =>
          throw cypherExceptionFactory.syntaxException(
            "Text indexes are not supported in this Cypher version.",
            c.position
          )
        ...
        case s: ShowIndexesClause if s.indexType == TextIndexes =>
          throw cypherExceptionFactory.syntaxException(
            "Filtering on text indexes in SHOW INDEXES is not supported in this Cypher version.",
            s.position
          )
        ...
        case c: CreatePointNodeIndex =>
          throw cypherExceptionFactory.syntaxException(
            "Point indexes are not supported in this Cypher version.",
            c.position
          )
        ...
        case s: ShowIndexesClause if s.indexType == PointIndexes =>
          throw cypherExceptionFactory.syntaxException(
            "Filtering on point indexes in SHOW INDEXES is not supported in this Cypher version.",
            s.position
          )
        ...
        case c: CreateNodeKeyConstraint if hasRangeOptions(c.options) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node key constraint backed by range index is not supported in this Cypher version.",
            c.position
          )
        case c: CreateUniquePropertyConstraint if hasRangeOptions(c.options) =>
          throw cypherExceptionFactory.syntaxException(
            "Creating uniqueness constraint backed by range index is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateNodePropertyExistenceConstraint if c.constraintVersion == ConstraintVersion2 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node existence constraint using `FOR ... REQUIRE` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateRelationshipPropertyExistenceConstraint if c.constraintVersion == ConstraintVersion2 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating relationship existence constraint using `FOR ... REQUIRE` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateNodeKeyConstraint if c.constraintVersion == ConstraintVersion2 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating node key constraint using `FOR ... REQUIRE` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: CreateUniquePropertyConstraint if c.constraintVersion == ConstraintVersion2 =>
          throw cypherExceptionFactory.syntaxException(
            "Creating uniqueness constraint using `FOR ... REQUIRE` is not supported in this Cypher version.",
            c.position
          )
        ...
        case p @ GrantPrivilege(DbmsPrivilege(ImpersonateUserAction), _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "IMPERSONATE privilege is not supported in this Cypher version.",
            p.position
          )
        ...
        case a: AlterDatabase =>
          throw cypherExceptionFactory.syntaxException(
            "The ALTER DATABASE command is not supported in this Cypher version.",
            a.position
          )
        ...
        case p @ GrantPrivilege(DbmsPrivilege(AlterDatabaseAction), _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "ALTER DATABASE privilege is not supported in this Cypher version.",
            p.position
          )
        ...
        case p @ GrantPrivilege(DbmsPrivilege(SetDatabaseAccessAction), _, _, _) =>
          throw cypherExceptionFactory.syntaxException(
            "SET DATABASE ACCESS privilege is not supported in this Cypher version.",
            p.position
          )
        ...
        case c: ShowTransactionsClause =>
          throw cypherExceptionFactory.syntaxException(
            "`SHOW TRANSACTIONS` is not supported in this Cypher version.",
            c.position
          )
        ...
        case c: TerminateTransactionsClause =>
          throw cypherExceptionFactory.syntaxException(
            "`TERMINATE TRANSACTIONS` is not supported in this Cypher version.",
            c.position
          )
