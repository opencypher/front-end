  ...
  Seq(
    ...
    case (verb: String, preposition: String, func: noResourcePrivilegeFunc) =>
      ...
      test(s"$verb TRAVERSE ON DEFAULT GRAPH $preposition role") {
        yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.DefaultGraphScope()(_)), List(ast.ElementsAllQualifier() _), Seq(literalRole)))
      }

      test(s"$verb TRAVERSE ON DEFAULT GRAPH NODE A $preposition role") {
        yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.DefaultGraphScope()(_)), List(labelQualifierA), Seq(literalRole)))
      }

      test(s"$verb TRAVERSE ON DEFAULT GRAPH RELATIONSHIP * $preposition role") {
        yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.DefaultGraphScope()(_)), List(ast.RelationshipAllQualifier() _), Seq(literalRole)))
      }

      test(s"$verb TRAVERSE ON DEFAULT GRAPH ELEMENT A $preposition role") {
        yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.DefaultGraphScope()(_)), List(elemQualifierA), Seq(literalRole)))
      }

      Seq("GRAPH", "GRAPHS").foreach {
        graphKeyword =>
          test(s"$verb TRAVERSE ON $graphKeyword * $preposition $$role") {
            yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.ElementsAllQualifier() _), Seq(paramRole)))
          }

          test(s"$verb TRAVERSE ON $graphKeyword foo $preposition role") {
            yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.ElementsAllQualifier() _), Seq(literalRole)))
          }

          test(s"$verb TRAVERSE ON $graphKeyword $$foo $preposition role") {
            yields(func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeParamFoo), List(ast.ElementsAllQualifier() _), Seq(literalRole)))
          }
            ...
            nodeKeyword =>
              ...
              test( s"validExpressions $verb $graphKeyword $nodeKeyword $preposition") {
                parsing(s"$verb TRAVERSE ON $graphKeyword * $nodeKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.LabelAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $nodeKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.LabelAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $nodeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $nodeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword `*` $nodeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("*")) _), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.LabelAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.LabelAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A (*) $preposition role1, $$role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA), Seq(literalRole1, paramRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword `2foo` $nodeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("2foo")) _), List(labelQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A (*) $preposition `r:ole`") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA), Seq(literalRColonOle))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword `A B` (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.LabelQualifier("A B") _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A, B (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA, labelQualifierB), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $nodeKeyword A, B (*) $preposition role1, role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(labelQualifierA, labelQualifierB), Seq(literalRole1, literalRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo, baz $nodeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo, graphScopeBaz), List(labelQualifierA), Seq(literalRole))
              }
            ...
            relTypeKeyword =>
              ...
              test( s"validExpressions $verb $graphKeyword $relTypeKeyword $preposition") {
                parsing(s"$verb TRAVERSE ON $graphKeyword * $relTypeKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.RelationshipAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $relTypeKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.RelationshipAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $relTypeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $relTypeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword `*` $relTypeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("*")) _), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.RelationshipAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.RelationshipAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A (*) $preposition $$role1, role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA), Seq(paramRole1, literalRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword `2foo` $relTypeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("2foo")) _), List(relQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A (*) $preposition `r:ole`") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA), Seq(literalRColonOle))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword `A B` (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.RelationshipQualifier("A B") _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A, B (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA, relQualifierB), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $relTypeKeyword A, B (*) $preposition role1, role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(relQualifierA, relQualifierB), Seq(literalRole1, literalRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo, baz $relTypeKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo, graphScopeBaz), List(relQualifierA), Seq(literalRole))
              }
            ...
            elementKeyword =>
              ...
              test( s"validExpressions $verb $graphKeyword $elementKeyword $preposition") {
                parsing(s"$verb TRAVERSE ON $graphKeyword * $elementKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.ElementsAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $elementKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(ast.ElementsAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $elementKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword * $elementKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.AllGraphsScope() _), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword `*` $elementKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("*")) _), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword * $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.ElementsAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword * (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.ElementsAllQualifier() _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A (*) $preposition role1, role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(elemQualifierA), Seq(literalRole1, literalRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword `2foo` $elementKeyword A (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(ast.NamedGraphScope(literal("2foo")) _), List(elemQualifierA), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A (*) $preposition `r:ole`") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(elemQualifierA), Seq(literalRColonOle))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword `A B` (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(ast.ElementQualifier("A B") _), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A, B (*) $preposition role") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo) , List(elemQualifierA, elemQualifierB), Seq(literalRole))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo $elementKeyword A, B (*) $preposition $$role1, $$role2") shouldGive
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo), List(elemQualifierA, elemQualifierB), Seq(paramRole1, paramRole2))
                parsing(s"$verb TRAVERSE ON $graphKeyword foo, baz $elementKeyword A (*) $preposition role")
                  func(ast.GraphPrivilege(ast.TraverseAction)(pos), List(graphScopeFoo, graphScopeBaz), List(elemQualifierA), Seq(paramRole))
              }
