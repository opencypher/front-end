...
final case class ShowUsers(override val yieldOrWhere: YieldOrWhere)(val position: InputPosition) extends ReadAdministrationCommand {
...
final case class ShowRoles(withUsers: Boolean, showAll: Boolean, override val yieldOrWhere: YieldOrWhere)(val position: InputPosition) extends ReadAdministrationCommand {
...
final case class ShowPrivileges(scope: ShowPrivilegeScope, override val yieldOrWhere: YieldOrWhere)(val position: InputPosition) extends ReadAdministrationCommand {
...
final case class ShowDatabase(scope: DatabaseScope, override val yieldOrWhere: YieldOrWhere)(val position: InputPosition) extends ReadAdministrationCommand {
